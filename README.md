...
| <a name="module_pve_ci_manager"></a> [pve\_ci\_manager](#module\_pve\_ci\_manager) | app.terraform.io/browningluke/cloud-init/pve | ~> 1.2.0 |
| <a name="module_pve_ci_worker"></a> [pve\_ci\_worker](#module\_pve\_ci\_worker) | app.terraform.io/browningluke/cloud-init/pve | ~> 1.2.0 |
